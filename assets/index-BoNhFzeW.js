(function(){const H=document.createElement("link").relList;if(H&&H.supports&&H.supports("modulepreload"))return;for(const O of document.querySelectorAll('link[rel="modulepreload"]'))m(O);new MutationObserver(O=>{for(const q of O)if(q.type==="childList")for(const Q of q.addedNodes)Q.tagName==="LINK"&&Q.rel==="modulepreload"&&m(Q)}).observe(document,{childList:!0,subtree:!0});function D(O){const q={};return O.integrity&&(q.integrity=O.integrity),O.referrerPolicy&&(q.referrerPolicy=O.referrerPolicy),O.crossOrigin==="use-credentials"?q.credentials="include":O.crossOrigin==="anonymous"?q.credentials="omit":q.credentials="same-origin",q}function m(O){if(O.ep)return;O.ep=!0;const q=D(O);fetch(O.href,q)}})();var dc={exports:{}},Da={};var br;function ad(){if(br)return Da;br=1;var z=Symbol.for("react.transitional.element"),H=Symbol.for("react.fragment");function D(m,O,q){var Q=null;if(q!==void 0&&(Q=""+q),O.key!==void 0&&(Q=""+O.key),"key"in O){q={};for(var j in O)j!=="key"&&(q[j]=O[j])}else q=O;return O=q.ref,{$$typeof:z,type:m,key:Q,ref:O!==void 0?O:null,props:q}}return Da.Fragment=H,Da.jsx=D,Da.jsxs=D,Da}var Rr;function nd(){return Rr||(Rr=1,dc.exports=ad()),dc.exports}var el=nd(),mc={exports:{}},ll={};var zr;function id(){if(zr)return ll;zr=1;var z=Symbol.for("react.transitional.element"),H=Symbol.for("react.portal"),D=Symbol.for("react.fragment"),m=Symbol.for("react.strict_mode"),O=Symbol.for("react.profiler"),q=Symbol.for("react.consumer"),Q=Symbol.for("react.context"),j=Symbol.for("react.forward_ref"),C=Symbol.for("react.suspense"),E=Symbol.for("react.memo"),X=Symbol.for("react.lazy"),B=Symbol.for("react.activity"),W=Symbol.iterator;function I(o){return o===null||typeof o!="object"?null:(o=W&&o[W]||o["@@iterator"],typeof o=="function"?o:null)}var nl={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},V=Object.assign,yl={};function Ol(o,_,h){this.props=o,this.context=_,this.refs=yl,this.updater=h||nl}Ol.prototype.isReactComponent={},Ol.prototype.setState=function(o,_){if(typeof o!="object"&&typeof o!="function"&&o!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,o,_,"setState")},Ol.prototype.forceUpdate=function(o){this.updater.enqueueForceUpdate(this,o,"forceUpdate")};function Hl(){}Hl.prototype=Ol.prototype;function Tl(o,_,h){this.props=o,this.context=_,this.refs=yl,this.updater=h||nl}var kl=Tl.prototype=new Hl;kl.constructor=Tl,V(kl,Ol.prototype),kl.isPureReactComponent=!0;var at=Array.isArray;function Xl(){}var il={H:null,A:null,T:null,S:null},Bl=Object.prototype.hasOwnProperty;function ct(o,_,h){var c=h.ref;return{$$typeof:z,type:o,key:_,ref:c!==void 0?c:null,props:h}}function vt(o,_){return ct(o.type,_,o.props)}function Pl(o){return typeof o=="object"&&o!==null&&o.$$typeof===z}function zl(o){var _={"=":"=0",":":"=2"};return"$"+o.replace(/[=:]/g,function(h){return _[h]})}var Ql=/\/+/g;function Zl(o,_){return typeof o=="object"&&o!==null&&o.key!=null?zl(""+o.key):_.toString(36)}function Vl(o){switch(o.status){case"fulfilled":return o.value;case"rejected":throw o.reason;default:switch(typeof o.status=="string"?o.then(Xl,Xl):(o.status="pending",o.then(function(_){o.status==="pending"&&(o.status="fulfilled",o.value=_)},function(_){o.status==="pending"&&(o.status="rejected",o.reason=_)})),o.status){case"fulfilled":return o.value;case"rejected":throw o.reason}}throw o}function b(o,_,h,c,d){var A=typeof o;(A==="undefined"||A==="boolean")&&(o=null);var p=!1;if(o===null)p=!0;else switch(A){case"bigint":case"string":case"number":p=!0;break;case"object":switch(o.$$typeof){case z:case H:p=!0;break;case X:return p=o._init,b(p(o._payload),_,h,c,d)}}if(p)return d=d(o),p=c===""?"."+Zl(o,0):c,at(d)?(h="",p!=null&&(h=p.replace(Ql,"$&/")+"/"),b(d,_,h,"",function(Y){return Y})):d!=null&&(Pl(d)&&(d=vt(d,h+(d.key==null||o&&o.key===d.key?"":(""+d.key).replace(Ql,"$&/")+"/")+p)),_.push(d)),1;p=0;var U=c===""?".":c+":";if(at(o))for(var N=0;N<o.length;N++)c=o[N],A=U+Zl(c,N),p+=b(c,_,h,A,d);else if(N=I(o),typeof N=="function")for(o=N.call(o),N=0;!(c=o.next()).done;)c=c.value,A=U+Zl(c,N++),p+=b(c,_,h,A,d);else if(A==="object"){if(typeof o.then=="function")return b(Vl(o),_,h,c,d);throw _=String(o),Error("Objects are not valid as a React child (found: "+(_==="[object Object]"?"object with keys {"+Object.keys(o).join(", ")+"}":_)+"). If you meant to render a collection of children, use an array instead.")}return p}function G(o,_,h){if(o==null)return o;var c=[],d=0;return b(o,c,"","",function(A){return _.call(h,A,d++)}),c}function J(o){if(o._status===-1){var _=o._result;_=_(),_.then(function(h){(o._status===0||o._status===-1)&&(o._status=1,o._result=h)},function(h){(o._status===0||o._status===-1)&&(o._status=2,o._result=h)}),o._status===-1&&(o._status=0,o._result=_)}if(o._status===1)return o._result.default;throw o._result}var _l=typeof reportError=="function"?reportError:function(o){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var _=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof o=="object"&&o!==null&&typeof o.message=="string"?String(o.message):String(o),error:o});if(!window.dispatchEvent(_))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",o);return}console.error(o)},hl={map:G,forEach:function(o,_,h){G(o,function(){_.apply(this,arguments)},h)},count:function(o){var _=0;return G(o,function(){_++}),_},toArray:function(o){return G(o,function(_){return _})||[]},only:function(o){if(!Pl(o))throw Error("React.Children.only expected to receive a single React element child.");return o}};return ll.Activity=B,ll.Children=hl,ll.Component=Ol,ll.Fragment=D,ll.Profiler=O,ll.PureComponent=Tl,ll.StrictMode=m,ll.Suspense=C,ll.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=il,ll.__COMPILER_RUNTIME={__proto__:null,c:function(o){return il.H.useMemoCache(o)}},ll.cache=function(o){return function(){return o.apply(null,arguments)}},ll.cacheSignal=function(){return null},ll.cloneElement=function(o,_,h){if(o==null)throw Error("The argument must be a React element, but you passed "+o+".");var c=V({},o.props),d=o.key;if(_!=null)for(A in _.key!==void 0&&(d=""+_.key),_)!Bl.call(_,A)||A==="key"||A==="__self"||A==="__source"||A==="ref"&&_.ref===void 0||(c[A]=_[A]);var A=arguments.length-2;if(A===1)c.children=h;else if(1<A){for(var p=Array(A),U=0;U<A;U++)p[U]=arguments[U+2];c.children=p}return ct(o.type,d,c)},ll.createContext=function(o){return o={$$typeof:Q,_currentValue:o,_currentValue2:o,_threadCount:0,Provider:null,Consumer:null},o.Provider=o,o.Consumer={$$typeof:q,_context:o},o},ll.createElement=function(o,_,h){var c,d={},A=null;if(_!=null)for(c in _.key!==void 0&&(A=""+_.key),_)Bl.call(_,c)&&c!=="key"&&c!=="__self"&&c!=="__source"&&(d[c]=_[c]);var p=arguments.length-2;if(p===1)d.children=h;else if(1<p){for(var U=Array(p),N=0;N<p;N++)U[N]=arguments[N+2];d.children=U}if(o&&o.defaultProps)for(c in p=o.defaultProps,p)d[c]===void 0&&(d[c]=p[c]);return ct(o,A,d)},ll.createRef=function(){return{current:null}},ll.forwardRef=function(o){return{$$typeof:j,render:o}},ll.isValidElement=Pl,ll.lazy=function(o){return{$$typeof:X,_payload:{_status:-1,_result:o},_init:J}},ll.memo=function(o,_){return{$$typeof:E,type:o,compare:_===void 0?null:_}},ll.startTransition=function(o){var _=il.T,h={};il.T=h;try{var c=o(),d=il.S;d!==null&&d(h,c),typeof c=="object"&&c!==null&&typeof c.then=="function"&&c.then(Xl,_l)}catch(A){_l(A)}finally{_!==null&&h.types!==null&&(_.types=h.types),il.T=_}},ll.unstable_useCacheRefresh=function(){return il.H.useCacheRefresh()},ll.use=function(o){return il.H.use(o)},ll.useActionState=function(o,_,h){return il.H.useActionState(o,_,h)},ll.useCallback=function(o,_){return il.H.useCallback(o,_)},ll.useContext=function(o){return il.H.useContext(o)},ll.useDebugValue=function(){},ll.useDeferredValue=function(o,_){return il.H.useDeferredValue(o,_)},ll.useEffect=function(o,_){return il.H.useEffect(o,_)},ll.useEffectEvent=function(o){return il.H.useEffectEvent(o)},ll.useId=function(){return il.H.useId()},ll.useImperativeHandle=function(o,_,h){return il.H.useImperativeHandle(o,_,h)},ll.useInsertionEffect=function(o,_){return il.H.useInsertionEffect(o,_)},ll.useLayoutEffect=function(o,_){return il.H.useLayoutEffect(o,_)},ll.useMemo=function(o,_){return il.H.useMemo(o,_)},ll.useOptimistic=function(o,_){return il.H.useOptimistic(o,_)},ll.useReducer=function(o,_,h){return il.H.useReducer(o,_,h)},ll.useRef=function(o){return il.H.useRef(o)},ll.useState=function(o){return il.H.useState(o)},ll.useSyncExternalStore=function(o,_,h){return il.H.useSyncExternalStore(o,_,h)},ll.useTransition=function(){return il.H.useTransition()},ll.version="19.2.3",ll}var Lr;function Ac(){return Lr||(Lr=1,mc.exports=id()),mc.exports}var Mt=Ac(),vc={exports:{}},Ua={},yc={exports:{}},gc={};var Mr;function fd(){return Mr||(Mr=1,(function(z){function H(b,G){var J=b.length;b.push(G);l:for(;0<J;){var _l=J-1>>>1,hl=b[_l];if(0<O(hl,G))b[_l]=G,b[J]=hl,J=_l;else break l}}function D(b){return b.length===0?null:b[0]}function m(b){if(b.length===0)return null;var G=b[0],J=b.pop();if(J!==G){b[0]=J;l:for(var _l=0,hl=b.length,o=hl>>>1;_l<o;){var _=2*(_l+1)-1,h=b[_],c=_+1,d=b[c];if(0>O(h,J))c<hl&&0>O(d,h)?(b[_l]=d,b[c]=J,_l=c):(b[_l]=h,b[_]=J,_l=_);else if(c<hl&&0>O(d,J))b[_l]=d,b[c]=J,_l=c;else break l}}return G}function O(b,G){var J=b.sortIndex-G.sortIndex;return J!==0?J:b.id-G.id}if(z.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var q=performance;z.unstable_now=function(){return q.now()}}else{var Q=Date,j=Q.now();z.unstable_now=function(){return Q.now()-j}}var C=[],E=[],X=1,B=null,W=3,I=!1,nl=!1,V=!1,yl=!1,Ol=typeof setTimeout=="function"?setTimeout:null,Hl=typeof clearTimeout=="function"?clearTimeout:null,Tl=typeof setImmediate<"u"?setImmediate:null;function kl(b){for(var G=D(E);G!==null;){if(G.callback===null)m(E);else if(G.startTime<=b)m(E),G.sortIndex=G.expirationTime,H(C,G);else break;G=D(E)}}function at(b){if(V=!1,kl(b),!nl)if(D(C)!==null)nl=!0,Xl||(Xl=!0,zl());else{var G=D(E);G!==null&&Vl(at,G.startTime-b)}}var Xl=!1,il=-1,Bl=5,ct=-1;function vt(){return yl?!0:!(z.unstable_now()-ct<Bl)}function Pl(){if(yl=!1,Xl){var b=z.unstable_now();ct=b;var G=!0;try{l:{nl=!1,V&&(V=!1,Hl(il),il=-1),I=!0;var J=W;try{t:{for(kl(b),B=D(C);B!==null&&!(B.expirationTime>b&&vt());){var _l=B.callback;if(typeof _l=="function"){B.callback=null,W=B.priorityLevel;var hl=_l(B.expirationTime<=b);if(b=z.unstable_now(),typeof hl=="function"){B.callback=hl,kl(b),G=!0;break t}B===D(C)&&m(C),kl(b)}else m(C);B=D(C)}if(B!==null)G=!0;else{var o=D(E);o!==null&&Vl(at,o.startTime-b),G=!1}}break l}finally{B=null,W=J,I=!1}G=void 0}}finally{G?zl():Xl=!1}}}var zl;if(typeof Tl=="function")zl=function(){Tl(Pl)};else if(typeof MessageChannel<"u"){var Ql=new MessageChannel,Zl=Ql.port2;Ql.port1.onmessage=Pl,zl=function(){Zl.postMessage(null)}}else zl=function(){Ol(Pl,0)};function Vl(b,G){il=Ol(function(){b(z.unstable_now())},G)}z.unstable_IdlePriority=5,z.unstable_ImmediatePriority=1,z.unstable_LowPriority=4,z.unstable_NormalPriority=3,z.unstable_Profiling=null,z.unstable_UserBlockingPriority=2,z.unstable_cancelCallback=function(b){b.callback=null},z.unstable_forceFrameRate=function(b){0>b||125<b?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Bl=0<b?Math.floor(1e3/b):5},z.unstable_getCurrentPriorityLevel=function(){return W},z.unstable_next=function(b){switch(W){case 1:case 2:case 3:var G=3;break;default:G=W}var J=W;W=G;try{return b()}finally{W=J}},z.unstable_requestPaint=function(){yl=!0},z.unstable_runWithPriority=function(b,G){switch(b){case 1:case 2:case 3:case 4:case 5:break;default:b=3}var J=W;W=b;try{return G()}finally{W=J}},z.unstable_scheduleCallback=function(b,G,J){var _l=z.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?_l+J:_l):J=_l,b){case 1:var hl=-1;break;case 2:hl=250;break;case 5:hl=1073741823;break;case 4:hl=1e4;break;default:hl=5e3}return hl=J+hl,b={id:X++,callback:G,priorityLevel:b,startTime:J,expirationTime:hl,sortIndex:-1},J>_l?(b.sortIndex=J,H(E,b),D(C)===null&&b===D(E)&&(V?(Hl(il),il=-1):V=!0,Vl(at,J-_l))):(b.sortIndex=hl,H(C,b),nl||I||(nl=!0,Xl||(Xl=!0,zl()))),b},z.unstable_shouldYield=vt,z.unstable_wrapCallback=function(b){var G=W;return function(){var J=W;W=G;try{return b.apply(this,arguments)}finally{W=J}}}})(gc)),gc}var pr;function cd(){return pr||(pr=1,yc.exports=fd()),yc.exports}var Sc={exports:{}},ut={};var Or;function _d(){if(Or)return ut;Or=1;var z=Ac();function H(C){var E="https://react.dev/errors/"+C;if(1<arguments.length){E+="?args[]="+encodeURIComponent(arguments[1]);for(var X=2;X<arguments.length;X++)E+="&args[]="+encodeURIComponent(arguments[X])}return"Minified React error #"+C+"; visit "+E+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function D(){}var m={d:{f:D,r:function(){throw Error(H(522))},D,C:D,L:D,m:D,X:D,S:D,M:D},p:0,findDOMNode:null},O=Symbol.for("react.portal");function q(C,E,X){var B=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:O,key:B==null?null:""+B,children:C,containerInfo:E,implementation:X}}var Q=z.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function j(C,E){if(C==="font")return"";if(typeof E=="string")return E==="use-credentials"?E:""}return ut.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=m,ut.createPortal=function(C,E){var X=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!E||E.nodeType!==1&&E.nodeType!==9&&E.nodeType!==11)throw Error(H(299));return q(C,E,null,X)},ut.flushSync=function(C){var E=Q.T,X=m.p;try{if(Q.T=null,m.p=2,C)return C()}finally{Q.T=E,m.p=X,m.d.f()}},ut.preconnect=function(C,E){typeof C=="string"&&(E?(E=E.crossOrigin,E=typeof E=="string"?E==="use-credentials"?E:"":void 0):E=null,m.d.C(C,E))},ut.prefetchDNS=function(C){typeof C=="string"&&m.d.D(C)},ut.preinit=function(C,E){if(typeof C=="string"&&E&&typeof E.as=="string"){var X=E.as,B=j(X,E.crossOrigin),W=typeof E.integrity=="string"?E.integrity:void 0,I=typeof E.fetchPriority=="string"?E.fetchPriority:void 0;X==="style"?m.d.S(C,typeof E.precedence=="string"?E.precedence:void 0,{crossOrigin:B,integrity:W,fetchPriority:I}):X==="script"&&m.d.X(C,{crossOrigin:B,integrity:W,fetchPriority:I,nonce:typeof E.nonce=="string"?E.nonce:void 0})}},ut.preinitModule=function(C,E){if(typeof C=="string")if(typeof E=="object"&&E!==null){if(E.as==null||E.as==="script"){var X=j(E.as,E.crossOrigin);m.d.M(C,{crossOrigin:X,integrity:typeof E.integrity=="string"?E.integrity:void 0,nonce:typeof E.nonce=="string"?E.nonce:void 0})}}else E==null&&m.d.M(C)},ut.preload=function(C,E){if(typeof C=="string"&&typeof E=="object"&&E!==null&&typeof E.as=="string"){var X=E.as,B=j(X,E.crossOrigin);m.d.L(C,X,{crossOrigin:B,integrity:typeof E.integrity=="string"?E.integrity:void 0,nonce:typeof E.nonce=="string"?E.nonce:void 0,type:typeof E.type=="string"?E.type:void 0,fetchPriority:typeof E.fetchPriority=="string"?E.fetchPriority:void 0,referrerPolicy:typeof E.referrerPolicy=="string"?E.referrerPolicy:void 0,imageSrcSet:typeof E.imageSrcSet=="string"?E.imageSrcSet:void 0,imageSizes:typeof E.imageSizes=="string"?E.imageSizes:void 0,media:typeof E.media=="string"?E.media:void 0})}},ut.preloadModule=function(C,E){if(typeof C=="string")if(E){var X=j(E.as,E.crossOrigin);m.d.m(C,{as:typeof E.as=="string"&&E.as!=="script"?E.as:void 0,crossOrigin:X,integrity:typeof E.integrity=="string"?E.integrity:void 0})}else m.d.m(C)},ut.requestFormReset=function(C){m.d.r(C)},ut.unstable_batchedUpdates=function(C,E){return C(E)},ut.useFormState=function(C,E,X){return Q.H.useFormState(C,E,X)},ut.useFormStatus=function(){return Q.H.useHostTransitionStatus()},ut.version="19.2.3",ut}var Nr;function sd(){if(Nr)return Sc.exports;Nr=1;function z(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(z)}catch(H){console.error(H)}}return z(),Sc.exports=_d(),Sc.exports}var Cr;function od(){if(Cr)return Ua;Cr=1;var z=cd(),H=Ac(),D=sd();function m(l){var t="https://react.dev/errors/"+l;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var e=2;e<arguments.length;e++)t+="&args[]="+encodeURIComponent(arguments[e])}return"Minified React error #"+l+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function O(l){return!(!l||l.nodeType!==1&&l.nodeType!==9&&l.nodeType!==11)}function q(l){var t=l,e=l;if(l.alternate)for(;t.return;)t=t.return;else{l=t;do t=l,(t.flags&4098)!==0&&(e=t.return),l=t.return;while(l)}return t.tag===3?e:null}function Q(l){if(l.tag===13){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function j(l){if(l.tag===31){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function C(l){if(q(l)!==l)throw Error(m(188))}function E(l){var t=l.alternate;if(!t){if(t=q(l),t===null)throw Error(m(188));return t!==l?null:l}for(var e=l,u=t;;){var a=e.return;if(a===null)break;var n=a.alternate;if(n===null){if(u=a.return,u!==null){e=u;continue}break}if(a.child===n.child){for(n=a.child;n;){if(n===e)return C(a),l;if(n===u)return C(a),t;n=n.sibling}throw Error(m(188))}if(e.return!==u.return)e=a,u=n;else{for(var i=!1,f=a.child;f;){if(f===e){i=!0,e=a,u=n;break}if(f===u){i=!0,u=a,e=n;break}f=f.sibling}if(!i){for(f=n.child;f;){if(f===e){i=!0,e=n,u=a;break}if(f===u){i=!0,u=n,e=a;break}f=f.sibling}if(!i)throw Error(m(189))}}if(e.alternate!==u)throw Error(m(190))}if(e.tag!==3)throw Error(m(188));return e.stateNode.current===e?l:t}function X(l){var t=l.tag;if(t===5||t===26||t===27||t===6)return l;for(l=l.child;l!==null;){if(t=X(l),t!==null)return t;l=l.sibling}return null}var B=Object.assign,W=Symbol.for("react.element"),I=Symbol.for("react.transitional.element"),nl=Symbol.for("react.portal"),V=Symbol.for("react.fragment"),yl=Symbol.for("react.strict_mode"),Ol=Symbol.for("react.profiler"),Hl=Symbol.for("react.consumer"),Tl=Symbol.for("react.context"),kl=Symbol.for("react.forward_ref"),at=Symbol.for("react.suspense"),Xl=Symbol.for("react.suspense_list"),il=Symbol.for("react.memo"),Bl=Symbol.for("react.lazy"),ct=Symbol.for("react.activity"),vt=Symbol.for("react.memo_cache_sentinel"),Pl=Symbol.iterator;function zl(l){return l===null||typeof l!="object"?null:(l=Pl&&l[Pl]||l["@@iterator"],typeof l=="function"?l:null)}var Ql=Symbol.for("react.client.reference");function Zl(l){if(l==null)return null;if(typeof l=="function")return l.$$typeof===Ql?null:l.displayName||l.name||null;if(typeof l=="string")return l;switch(l){case V:return"Fragment";case Ol:return"Profiler";case yl:return"StrictMode";case at:return"Suspense";case Xl:return"SuspenseList";case ct:return"Activity"}if(typeof l=="object")switch(l.$$typeof){case nl:return"Portal";case Tl:return l.displayName||"Context";case Hl:return(l._context.displayName||"Context")+".Consumer";case kl:var t=l.render;return l=l.displayName,l||(l=t.displayName||t.name||"",l=l!==""?"ForwardRef("+l+")":"ForwardRef"),l;case il:return t=l.displayName||null,t!==null?t:Zl(l.type)||"Memo";case Bl:t=l._payload,l=l._init;try{return Zl(l(t))}catch{}}return null}var Vl=Array.isArray,b=H.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G=D.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,J={pending:!1,data:null,method:null,action:null},_l=[],hl=-1;function o(l){return{current:l}}function _(l){0>hl||(l.current=_l[hl],_l[hl]=null,hl--)}function h(l,t){hl++,_l[hl]=l.current,l.current=t}var c=o(null),d=o(null),A=o(null),p=o(null);function U(l,t){switch(h(A,t),h(d,l),h(c,null),t.nodeType){case 9:case 11:l=(l=t.documentElement)&&(l=l.namespaceURI)?Jo(l):0;break;default:if(l=t.tagName,t=t.namespaceURI)t=Jo(t),l=wo(t,l);else switch(l){case"svg":l=1;break;case"math":l=2;break;default:l=0}}_(c),h(c,l)}function N(){_(c),_(d),_(A)}function Y(l){l.memoizedState!==null&&h(p,l);var t=c.current,e=wo(t,l.type);t!==e&&(h(d,l),h(c,e))}function K(l){d.current===l&&(_(c),_(d)),p.current===l&&(_(p),pa._currentValue=J)}var k,P;function F(l){if(k===void 0)try{throw Error()}catch(e){var t=e.stack.trim().match(/\n( *(at )?)/);k=t&&t[1]||"",P=-1<e.stack.indexOf(`
    at`)?" (<anonymous>)":-1<e.stack.indexOf("@")?"@unknown:0:0":""}return`
`+k+l+P}var al=!1;function nt(l,t){if(!l||al)return"";al=!0;var e=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var u={DetermineComponentFrameRoot:function(){try{if(t){var M=function(){throw Error()};if(Object.defineProperty(M.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(M,[])}catch(T){var S=T}Reflect.construct(l,[],M)}else{try{M.call()}catch(T){S=T}l.call(M.prototype)}}else{try{throw Error()}catch(T){S=T}(M=l())&&typeof M.catch=="function"&&M.catch(function(){})}}catch(T){if(T&&S&&typeof T.stack=="string")return[T.stack,S.stack]}return[null,null]}};u.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var a=Object.getOwnPropertyDescriptor(u.DetermineComponentFrameRoot,"name");a&&a.configurable&&Object.defineProperty(u.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var n=u.DetermineComponentFrameRoot(),i=n[0],f=n[1];if(i&&f){var s=i.split(`
`),g=f.split(`
...
255  LATIN SMALL LETTER Y WITH DIAERESIS
 ...
 \\__, /   @
/____/    @@
`}});function Pn(z,H){return z.replace(/.(?=.)/g,`$&${" ".repeat(H)}`)}function Ec(z,H,D){return z.substring(0,H)+D+z.substring(H+D.length)}function qr(z){return z[Math.floor(Math.random()*z.length)]}function Yu(z,H){return z.split("").map(D=>/\s/.test(D)?D:qr(H)).join("")}function Rd({asciiText:z,animationDirection:H,animationCharacters:D,animationCharacterSpacing:m}){return z.reduce((O,q,Q)=>{if(Q===0)return O;const j=O?.[O.length-1]?[...O[O.length-1]]:void 0;if(!j)return O;const C=/\S/.test(j[Q-1]),E=j.length-Q,X=/\S/.test(j[E]);let B=[...j];if(C&&(H==="up"||H==="vertical")&&(j?.[Q]&&(j[Q]=Yu(j[Q],Pn(D,m))),j?.[Q-1]&&(j[Q-1]=" ".repeat(q.length)),B[Q]&&(B[Q]=Yu(B[Q],D))),X&&(H==="down"||H==="vertical")&&(j?.[E]&&(j[E]=Yu(j[E],Pn(D,m))),j?.[E+1]&&(j[E+1]=" ".repeat(q.length)),B?.[E]&&(B[E]=Yu(B[E],D))),(C||X)&&O.push(B,j),Q===z.length-1&&H==="up"){const W=[...j];W[W.length-1]=" ".repeat(W[W.length-1].length),O.push(W)}if(Q===z.length-1&&H==="down"){const W=[...j];W[B.length-Q]=" ".repeat(W[B.length-Q].length),O.push(W);const I=[...W];if(!/\S/.test(I[0]))return O;I[0]=Yu(I[0],Pn(D,m)),O.push(I);const V=[...I];if(!/\S/.test(V[0]))return O;V[0]=Yu(V[0],Pn(D,m)),O.push(V);const yl=[...V];if(!/\S/.test(yl[0]))return O;yl[0]=" ".repeat(yl[0].length),O.push(yl)}return z.length-1,O},[[...z]])}var zd=1;function Ld({asciiText:z,animationDirection:H,animationCharacters:D}){const m=[[...structuredClone(z)]],O=z[0].length/(H==="left"||H==="right"?1:2);for(let q=0;q<O;q++){if(q===0){m.push(z);continue}const Q=m[q].map((j,C,E)=>{const X=j.search(/\S/),B=j.search(/\S(?!.*\S)/);if(X===-1||B===-1)return j;const W=C>zd?-1:1;if((H==="left"||H==="horizontal")&&(j=Ec(j,X," ")),(H==="right"||H==="horizontal")&&(j=Ec(j,B," ")),B-X<=2)return j;if(H==="left"||H==="horizontal"){const I=qr(D);E[C+W]=Ec(E[C+W],X+1,I)}return j});m.push(Q)}return m}function Md(z){return lu(this,arguments,function*({asciiText:H,animationDirection:D,animationCharacters:m,animationCharacterSpacing:O,fadeInOnly:q=!1,fadeOutOnly:Q=!1}){try{if(D==="down"||D==="up"||D==="vertical"){const X=Rd({asciiText:H,animationDirection:D,animationCharacters:m,animationCharacterSpacing:O});if(Q)return X;const B=structuredClone(X).reverse();return q?B:B.concat(X)}const j=Ld({asciiText:H,animationDirection:D,animationCharacters:m,animationCharacterSpacing:O});if(q)return structuredClone(j).reverse();const C=structuredClone(j).reverse();return Q?j:C.concat(j)}catch(j){throw j+" @createFrames"}})}var Br="Slant";function pd(z,H){return lu(this,null,function*(){Ur.parseFont(Br,H);const D=C=>lu(this,null,function*(){return yield new Promise((E,X)=>{Ur.text(C,{font:Br},(B,W)=>{B&&X("Failed to load font"),W?E(W.split(`
`)):X("No ASCII text generated")})})}),m=[];try{for(var O=Ed(Array.isArray(z)?z:[z]),q,Q,j;q=!(Q=yield O.next()).done;q=!1){const C=Q.value,E=yield D(C);m.push(E)}}catch(C){j=[C]}finally{try{q&&(Q=O.return)&&(yield Q.call(O))}finally{if(j)throw j[0]}}return m})}var Od="/*+#";function Nd({animationCharacters:z=Od,animationCharacterSpacing:H=1,animationDelay:D=500,animationDirection:m="horizontal",animationInterval:O=1e3,animationIteration:q=1,animationLoop:Q=!0,animationSpeed:j=20,fadeInOnly:C=!1,fadeOutOnly:E=!1,font:X,isAnimated:B=!0,isPaused:W=!1,text:I=["React","ASCII","Text"]}){const nl=Mt.useRef(),V=Mt.useRef({animationFrameId:0,animationIndex:0,animationIterationCount:1,animations:null,frameId:0,frameIndex:0,isPaused:!1,isTimeout:!1,previousTimeStamp:0,timeoutId:0}),yl=Hl=>lu(this,null,function*(){const{animations:Tl,isPaused:kl,isTimeout:at,previousTimeStamp:Xl}=V.current;if(!nl.current||!Tl?.length||kl||at)return;if(Hl-Xl>j){const{animationIndex:Bl,animationIterationCount:ct,animations:vt,frameId:Pl,frameIndex:zl}=V.current,Ql=vt?.[Bl];if(!Ql||at)return;const Zl=zl===0,Vl=zl===Ql.length-1,b=Bl===vt.length-1;if(nl.current.textContent=Ql[zl].join(`
`),!Q&&ct===q&&b&&Vl){cancelAnimationFrame(Pl);return}V.current.previousTimeStamp=Hl;const G=zl===Math.floor(Ql.length/2),J=C||E,_l=hl=>lu(this,null,function*(){yield new Promise(o=>{V.current.isTimeout=!0,setTimeout(o,hl)}),V.current.isTimeout=!1});J&&Vl&&D&&(yield _l(D)),J&&Zl&&O&&(yield _l(O)),!J&&G&&D&&(yield _l(D)),!J&&Vl&&O&&(yield _l(O)),Vl?(V.current.frameIndex=0,V.current.animationIndex++,V.current.animationIterationCount++):V.current.frameIndex++,Q&&V.current.animationIndex===vt.length&&(V.current.animationIndex=0)}V.current.frameId=requestAnimationFrame(yl)});Mt.useEffect(()=>{W?(V.current.isPaused=!0,cancelAnimationFrame(V.current.frameId)):(V.current.isPaused=!1,V.current.frameId=requestAnimationFrame(yl))},[W,V]);const Ol=Mt.useCallback(()=>lu(this,null,function*(){try{const Hl=yield pd(I,X);!B&&nl.current?nl.current.textContent=Hl[0].join(`
`):Hl.length===(Array.isArray(I)?I:[I]).length&&(V.current.animations=yield Promise.all([...Hl.map(Tl=>lu(this,null,function*(){return yield Md({asciiText:Tl,animationDirection:m,animationCharacters:z,animationCharacterSpacing:H,fadeInOnly:C,fadeOutOnly:E})}))]),requestAnimationFrame(yl))}catch(Hl){console.error({error:Hl})}}),[]);return Mt.useEffect(()=>{Ol()},[I,Ol]),nl}var Cd=`flf2a$ 9 8 12 63 18 0 24511 0
Font   : Fire Font-s
Author : MJP
...
| (_) | #
$\\___/$ #
        ##`;bd();function Dd(){const z=Mt.useRef(null),[H,D]=Mt.useState("dark"),m=["dark","light","cyber","dracula"],O=[],q=Nd({font:Cd,isAnimated:!1,text:"geoorgeq"}),[Q,j]=Mt.useState([el.jsx("pre",{style:{marginTop:"-35px"},ref:q},0),el.jsx(kn,{onEnter:C,inputRef:z,inputs:O},1)]);function C(E){O.push(E);const X=[],B=E.toLowerCase().split(" "),W=B[0],I=B[1];switch(W){case"ls":X.push(el.jsx("div",{children:"List of projects"}));break;case"help":X.push(el.jsxs("div",{className:"output-block",children:[el.jsx("div",{children:"Use the following commands"}),el.jsx("div",{children:"ls - to list all the personal projects"}),el.jsx("div",{children:"about - learn something about me"}),el.jsx("div",{children:"theme - change the theme of the terminal"}),el.jsx("div",{children:"theme list - list of available themes"})]}));break;case"about":X.push(el.jsxs("div",{className:"output-block about",children:[el.jsx("div",{children:"I am an eager and motivated beginner programmer with a strong"}),el.jsx("div",{children:"passion for learning and a commitment to honing my coding skills."}),el.jsx("div",{children:"My goal is to build a solid foundation in software development and"}),el.jsx("div",{children:"continuously improve my abilities through hands-on experience and"}),el.jsx("div",{children:"collaboration with others in the programming community."})]}));break;case"clear":j([el.jsx("pre",{style:{marginTop:"-35px"},ref:q},0),el.jsx(kn,{onEnter:C,inputRef:z,inputs:O},1)]);return;case"theme":{if(I==="list"){X.push(el.jsx("div",{className:"output-block",children:"List of themes:"}));for(let nl=0;nl<=m.length;nl++)X.push(el.jsx("div",{className:"output-block capitalized-text",children:m[nl]}))}else if(m.indexOf(I)===-1&&I!==void 0&&I!=="")X.push(el.jsxs("div",{children:["Theme not found. Use"," ",el.jsx("span",{style:{color:"var(--accent)"},children:"theme list "}),"to see available themes."]}));else if(I)D(I),X.push(el.jsxs("div",{children:["Theme switched to ",el.jsx("span",{className:"capitalized-text",children:I})]}));else{console.log(I);let nl="";D(V=>{const Ol=(m.indexOf(V)+1)%m.length;return nl=m[Ol],m[Ol]}),X.push(el.jsxs("div",{children:["Theme switched to ",el.jsx("span",{className:"capitalized-text",children:nl})]}))}break}default:X.push(el.jsxs("div",{children:["Command not found. Type"," ",el.jsx("span",{style:{color:"var(--accent)"},children:"help"})," to find all available commands."]}))}j(nl=>[...nl.map(V=>V.type===kn?el.jsxs("div",{className:"terminal-input",children:[el.jsxs("span",{children:["guest@geoorgeq.computer",el.jsx("span",{style:{color:"var(--success)"},children:":~$"})]}),el.jsx("div",{style:{marginLeft:"var(--p-3)"},children:E})]},V.key):V),el.jsx("div",{children:X},nl.length),el.jsx(kn,{onEnter:C,inputRef:z,inputs:O},nl.length+1)])}return Mt.useEffect(()=>{z.current?.focus()},[Q]),el.jsx("div",{className:`app theme-${H}`,children:el.jsx("div",{className:"terminal",onClick:()=>z.current?.focus(),children:Q})})}hd.createRoot(document.getElementById("root")).render(el.jsx(Mt.StrictMode,{children:el.jsx(Dd,{})}));
